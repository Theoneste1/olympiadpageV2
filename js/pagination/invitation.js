...
let SHEET_TITLE = 'INVITATION2024';
let SHEET_RANGE = 'A1:M155'
...
.then(rep => {
    ...
    console.log(data)
    console.log("--------------------------------")
    console.log(data.table.rows[1].c[7].v)
        ...
        //check how many students
         function countOfstudents(){
            ...
            for(j=0; j<length; j++){
                ...
                let compare =data.table.rows[j].c[7].v
   ...
   // get the number of the students
    ...
    function createPageList() {
        ...
        for (i = 0; i<length; i++) {
                ...
                let compare =data.table.rows[i].c[7].v
                ...
                row.appendChild(headerCell);
                   ...
                   style.classList.remove("remove");
                    ...
                    // school informations
                    document.getElementById("schoolname").innerHTML=data.table.rows[index].c[7].v;
