...
.then(rep => {
    ...
    // console.log(data)
    console.log(data.table.rows[1].c[12].v)
        ...
        //check how many students
         function countOfstudents(){
            ...
            for(j=0; j<length; j++){
                ...
                let compare =data.table.rows[j].c[12].v
   ...
   // get the number of the students
    ...
    function createPageList() {
        ...
        for (i = 0; i<length; i++) {
                ...
                let compare =data.table.rows[i].c[12].v
                ...
                headerCell = document.createElement("td");
                headerCell.innerHTML = data.table.rows[i].c[11].v;
