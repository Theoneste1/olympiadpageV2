...
let SHEET_TITLE = 'SCHOOL2024';
let SHEET_RANGE = 'A1:H600'
...
.then(rep => {
    ...
    // console.log(data)
    console.log(data.table.rows[1].c[3].v)
    ...
    console.log("This is length ", length)
        ...
        headerCell = document.createElement("TH");
        headerCell.innerHTML = "BANK ACCOUNT";
        row.appendChild(headerCell);
   ...
   // get the number of the students
    ...
    function createPageList() {
        ...
        for (i = 0; i<length; i++) {
                ...
                let compare =data.table.rows[i].c[3].v
