...
function getCountOfPages() {
   ...
   // get the number of the students
        ...
        for (i = 0; i<length; i++) {
                ...
                row.appendChild(headerCell);
                   ...
                   style.classList.remove("remove");
                    ...
                    document.getElementById("snumber").innerHTML=data.table.rows[0].c[5].v
    ...
    // getting the size of table.
        ...
        let currentIndex=code.innerHTML;

document.getElementById('next').addEventListener('click', function() {
    if (currentIndex < 2025) {
        currentIndex++;
        code = currentIndex;
        console.log(code);
        // cleaning()
